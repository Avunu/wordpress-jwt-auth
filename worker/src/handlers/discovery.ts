...
/** OIDC discovery document. Only issuer/authorization/token/jwks are read by the plugin;
 *  the rest are standard, harmless, and make the endpoint recognisably OIDC. */
