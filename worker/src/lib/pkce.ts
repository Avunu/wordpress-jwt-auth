...
/**
 * Verify an RFC 7636 PKCE S256 challenge: BASE64URL(SHA-256(code_verifier)) === code_challenge.
 * The plugin always uses S256 (never "plain"), so that is all we support.
 */
